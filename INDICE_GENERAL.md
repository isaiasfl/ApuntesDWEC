...
Este índice permite moverse por todo el material sin depender solo de la vista de carpetas de GitHub.
...
| 3 | Cargar JavaScript en HTML | [3_CargarJavaScript.md](Unidad2_Sintaxis_Basica/3_CargarJavaScript.md) |
...
| 13 | Node, npm, pnpm y Vite | [13_NPM.md](Unidad4_Estructuras_de_datos/13_NPM.md) |
...
| 16 | POO y prototipos | [16_POO_basado_en_Prototipos.md](Unidad5_POO_basada_en_Prototipos/16_POO_basado_en_Prototipos.md) |
| 17 | DOM | [17_DOM_Document_Object_Model.md](Unidad6_DOM/17_DOM_Document_Object_Model.md) |
| 18 | Asincronía | [18_Asincronismo.Callback_Promesas_Async_Await.md](Unidad6_DOM/18_Asincronismo.Callback_Promesas_Async_Await.md) |
| 19 | Web APIs | [19_APIS_JavaScript.md](Unidad6_DOM/19_APIS_JavaScript.md) |
| 20 | Preparación React / Angular | [20_Preparacion_React_Angular.md](Unidad7_Preparacion_React_Angular/20_Preparacion_React_Angular.md) |
...
- [Autocorregibles](Ejercicios/autocorregibles/README.md)
